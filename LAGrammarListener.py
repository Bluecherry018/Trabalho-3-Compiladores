...
class LAGrammarListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by LAGrammarParser#relacional.
    def enterRelacional(self, ctx:LAGrammarParser.RelacionalContext):
        pass

    # Exit a parse tree produced by LAGrammarParser#relacional.
    def exitRelacional(self, ctx:LAGrammarParser.RelacionalContext):
        pass
